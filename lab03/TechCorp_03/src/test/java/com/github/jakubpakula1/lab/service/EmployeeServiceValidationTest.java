...
class EmployeeServiceValidationTest {
    ...
    void testAddEmployeeEmptyEmail() {
        Employee employee = new Employee("John", "Doe", "Acme", "", Position.PROGRAMISTA, BigDecimal.valueOf(5000));
    ...
    void testAddEmployeeNegativeSalary() {
        Employee employee = new Employee("John", "Doe", "Acme", "john@techcorp.com", Position.PROGRAMISTA, BigDecimal.valueOf(-5000));
        employee.setStatus(EmploymentStatus.ACTIVE);
    ...
    void testAddEmployeeWrongDomain() {
        Employee employee = new Employee("John", "Doe", "Acme", "john@example.com", Position.PROGRAMISTA, BigDecimal.valueOf(5000));
        employee.setStatus(EmploymentStatus.ACTIVE);
    ...
    void testAddEmployeeShortFirstName() {
        Employee employee = new Employee("J", "Doe", "Acme", "john@techcorp.com", Position.PROGRAMISTA, BigDecimal.valueOf(5000));
        employee.setStatus(EmploymentStatus.ACTIVE);
    ...
    void testUpdateEmployeeNegativeSalary() {
        ...
        Employee updated = new Employee("John", "Doe", "Acme", "john@techcorp.com", Position.PROGRAMISTA, BigDecimal.valueOf(-5000));
